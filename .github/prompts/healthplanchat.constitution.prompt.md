...
argument-hint: Optionally provide audience and constraints
---
...
Avoid locking into specific frameworks, project structure, SDK versions, or
deployment topology unless a constraint truly requires it.

Write the output to `.specify/memory/constitution.md`, replacing placeholders.
