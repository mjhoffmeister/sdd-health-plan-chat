...
refreshing prompts, and managing phase tags). It is intentionally not part of
normal "run the demo" instructions.
...
- `git tag -f phase/01-constitution`
- `git push -f origin phase/01-constitution`
